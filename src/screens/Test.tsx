        ...
        <ImageBackground source={BackgroundImg} style={styles.Img}>
          ...
          >
            ...
            >
              ...
              <Pressable onPress={()=>navigate.goBack()} style={{display:"flex",backgroundColor:"#505352",flexDirection:"row",alignItems:"center",justifyContent:"center",paddingHorizontal:10}}>
            ...
            >
              ...
              <Pressable onPress={()=>OpenReport(0)} style={{marginTop:verticalScale(14),display:'flex',flexDirection:"row",alignItems:"center",columnGap:moderateScale(12)}} >
              <FontAwesomeIcon icon={faTriangleExclamation} size={24} color={Colors.yellow} />
              <Text style={{color:Colors.white}} >Report issue</Text>
              <ModalBox setShowModal={setShowModal} showModal={showModal} popUpModal={popUpModal} />
              </Pressable>
            </View>
          </View>
        </ImageBackground>
